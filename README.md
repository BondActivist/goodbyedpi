...
**[BondActivist/goodbyedpi](https://github.com/BondActivist/goodbyedpi)** — сборка для Windows 10/11

[**⬇ Скачать последний релиз**](https://github.com/BondActivist/goodbyedpi/releases/latest)
...
> Если вы наткнулись на что-то вне репозитория `BondActivist/goodbyedpi`, что распространяется от моего лица — **ФЕЙК**.
...
1. Откройте [**Releases → Latest**](https://github.com/BondActivist/goodbyedpi/releases/latest) и скачайте **`.rar`** (предпочтительно)
